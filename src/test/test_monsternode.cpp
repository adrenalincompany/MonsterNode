...
#define BOOST_TEST_MODULE MonsterNode Test Suite

#include "test_monsternode.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_monsternode_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
