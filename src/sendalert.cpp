...
2. run monsternoded with -printalert or -sendalert like this:
   /path/to/monsternoded -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.monsternode.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/MonsterNode Core:0.12.0.58/"));
