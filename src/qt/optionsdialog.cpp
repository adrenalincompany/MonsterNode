    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MNTC-light"), QVariant("light"));
    ui->theme->addItem(QString("MNTC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MNTC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MNTC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MNTC-traditional"), QVariant("trad"));
