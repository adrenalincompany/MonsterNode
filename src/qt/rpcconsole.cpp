...
bool parseCommandLine(std::vector<std::string> &args, const std::string &strCommand)
{
    ...
    Q_FOREACH(char ch, strCommand)
    {
        switch(state)
        {
        case STATE_ARGUMNTCT: // In or after argument
        case STATE_EATING_SPACES: // Handle runs of whitespace
            ...
            case ' ': case '\n': case '\t':
                if(state == STATE_ARGUMNTCT) // Space ends argument
                {
                ...
                state = STATE_EATING_SPACES;
                break;
            default: curarg += ch; state = STATE_ARGUMNTCT;
            }
            break;
        case STATE_SINGLEQUOTED: // Single-quoted string
            switch(ch)
            {
            case '\'': state = STATE_ARGUMNTCT; break;
            default: curarg += ch;
            }
            break;
        ...
        case STATE_ESCAPE_OUTER: // '\' outside quotes
            curarg += ch; state = STATE_ARGUMNTCT;
            break;
...
void RPCConsole::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MonsterNode Core RPC console.") + "<br>" +
