    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MonsterNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MonsterNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and monsternode: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MonsterNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about MonsterNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MonsterNode Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MonsterNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MonsterNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a monsternode: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MonsterNode Core help message to get a list with possible MonsterNode Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MonsterNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MonsterNode network", "", count));
    } else {
...
{
    QString strTitle = tr("MonsterNode Core"); // default title
    ...
    // Append title to "MonsterNode Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
