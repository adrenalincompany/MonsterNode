    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MonsterNode Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MonsterNode Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  monsternode-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MonsterNode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other monsternode, without having your coins ever leave your wallet. \
...
These denominations are 0.01 MNTC, 0.1 MNTC, 1 MNTC and 10 MNTC -- sort of like the paper money you use every day.</li> \
...
<li>When two other monsternode send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://MonsterNodeDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://MonsterNodeDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MonsterNode Core is shutting down...") + "<br /><br />" +
