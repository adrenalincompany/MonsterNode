...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("MonsterNode Core monsternode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  monsternode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded monsternode transaction") + "\n" +
              "  monsternode-tx [options] -create [commands]   " + _("Create hex-encoded monsternode transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded monsternode transaction
