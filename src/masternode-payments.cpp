...
*
*   Why is this needed?
*   - In MonsterNode some blocks are superblocks, which output much higher amounts of coins
...
bool CMasternodeBlockPayees::IsTransactionValid(const CTransaction& txNew)
{
    ...
    LogPrintf("CMasternodeBlockPayees::IsTransactionValid -- ERROR: Missing required payment, possible payees: '%s', amount: %f MONSTERNODE\n", strPayeesPossible, (float)nMasternodePayment/COIN);
    return false;
}
