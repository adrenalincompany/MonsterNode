...
enum GovernanceObjectType {
    ...
    // -------------------------------
    // MonsterNodeNetwork - is the root node
    MonsterNodeNetwork = 1000,
    MonsterNodeNetworkVariable = 1001,
    Category = 1002,
    ...
    //   --  monsternode that operate DAOs will own companies which can own things legally
    Group = 2000,
    User = 2001,
    Company = 2002,
