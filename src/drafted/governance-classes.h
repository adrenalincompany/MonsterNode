 ...
 *
 *   // network
 *   CMonsterNodeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.monsternode.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMonsterNodeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMonsterNodeNetwork(UniValue objIn)
    {
...
// // can be under: MonsterNodeNetwork
// //   -- signature requirements : Key1(User)
// class CMonsterNodeNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == MonsterNodeNetwork);
//     // }
