...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MonsterNodeNetwork") type = MonsterNodeNetwork;
    if(strType == "MonsterNodeNetworkVariable") type = MonsterNodeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MonsterNodeNetwork) s = "MonsterNodeNetwork";
    if(type == MonsterNodeNetworkVariable) s = "MonsterNodeNetworkVariable";
