...
This mechanism has been integrated into Bitcore-Node-MonsterNode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/monsternodeproject/insight-api-monsternode#web-socket-api](https://github.com/monsternodeproject/insight-api-monsternode#web-socket-api)
* API: [https://github.com/monsternodeproject/insight-api-monsternode#instantsend-transactions](https://github.com/monsternodeproject/insight-api-monsternode#instantsend-transactions)
...
By default, the MonsterNode Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MonsterNode Core daemon:
