...
Only requiring some minor changes is monsternode.cpp.
...
Changes to monsternode.cpp
----------------------
monsternode.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
