...
MonsterNode Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as MonsterNode Core, where everyone uses
...
pay attention to for reviewers of MonsterNode Core code.

General MonsterNode Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: MonsterNode Core uses tinyformat, which is type safe. Leave them out to avoid confusion
