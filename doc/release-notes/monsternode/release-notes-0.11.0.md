...
- Add '-disablewallet' mode to let monsternoded run entirely without wallet (when
  built with wallet)
- Update default '-rpcsslciphers' to include TLSv1.2
- make '-logtimestamps' default on and rework help-message
- RPC client option: '-rpcwait', to wait for server start
- Remove '-logtodebugger'
- Allow `-noserver` with monsternoded
...
- Upgrade OpenSSL to 1.0.1i, includes CVE-2018-0224, CVE-2018-0160 and
  CVE-2018-0076 (see https://www.openssl.org/news/secadv_20140806.txt)
